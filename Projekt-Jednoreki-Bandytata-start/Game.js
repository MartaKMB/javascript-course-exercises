...
class Game {
    constructor(start) {
        ...
        this.wallet = new Wallet(start); // instancje klas

        document.getElementById('start').addEventListener('click', this.startGame.bind(this)); // .bind(this) - związanie z Game, bo w momencie startGame this jest buttonem
